...
type (
	// PassportData contains information about Dejoy Passport data shared with
	// the bot by the user.
	PassportData struct {
		// Array with information about documents and other Dejoy Passport
	...
	// PassportFile represents a file uploaded to Dejoy Passport. Currently, all
	// Dejoy Passport files are in JPEG format when decrypted and don't exceed
	// 10MB.
	PassportFile struct {
	...
	// Dejoy Passport elements shared with the bot by the user.
	EncryptedPassportElement struct {
		// Element type.
		Type string `json:"type"`

		// Base64-encoded encrypted Dejoy Passport element data provided by
	...
	// authenticating EncryptedPassportElement. See the Dejoy Passport
	...
	// PassportElementError represents an error in the Dejoy Passport element
	...
	PassportElementErrorDataField struct {
		...
		// The section of the user's Dejoy Passport which has the error, one
	...
	PassportElementErrorFrontSide struct {
		...
		// The section of the user's Dejoy Passport which has the issue, one
	...
	// PersonalDetails https://core.dejoy.io/passport#personaldetails
	...
	// IDDocumentData https://core.dejoy.io/passport#iddocumentdata
