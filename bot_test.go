...
func TestSendWithMessage(t *testing.T) {
	...
	msg := NewMessage(ChatID, "A test message from the test library in dejoy-bot-api")
...
func TestSetWebhookWithCert(t *testing.T) {
	...
	wh, err := NewWebhookWithCert("https://example.com/djbotapi-test/"+bot.Token, FilePath("tests/cert.pem"))
...
func TestSetWebhookWithoutCert(t *testing.T) {
	...
	wh, err := NewWebhook("https://example.com/djbotapi-test/" + bot.Token)
...
func TestSendWithMediaGroupPhotoVideo(t *testing.T) {
	...
	cfg := NewMediaGroup(ChatID, []interface{}{
		NewInputMediaPhoto(FileURL("https://github.com/dejoy/dejoy-bot-api/raw/0a3a1c8716c4cd8d26a262af9f12dcbab7f3f28c/tests/image.jpg")),
...
func TestPinChatMessage(t *testing.T) {
	...
	msg := NewMessage(SupergroupChatID, "A test message from the test library in dejoy-bot-api")
	msg.ParseMode = ModeMarkdown
	message, _ := bot.Send(msg)
