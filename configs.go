...
// FileID is an ID of a file already uploaded to Dejoy.
type FileID string
...
// FileConfig has information about a file hosted on Dejoy.
...
//
// This was renamed to BanChatMember in later versions of the Dejoy Bot API.
