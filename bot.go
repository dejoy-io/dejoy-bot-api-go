// Package djbotapi has functions and types used for interacting with
// the Dejoy Bot API.
package djbotapi
...
// BotAPI allows you to interact with the Dejoy Bot API.
type BotAPI struct {
...
//
// It requires a token, provided by @BotFather on Dejoy.
...
//
// It requires a token, provided by @BotFather on Dejoy and API endpoint.
...
// SetAPIEndpoint changes the Dejoy Bot API endpoint used by the instance.
...
func (bot *BotAPI) UploadFiles(endpoint string, params Params, files []RequestFile) (*APIResponse, error) {
	...
	// https://github.com/dejoy-io/dejoy-bot-api/issues/354#issuecomment-663856473
	go func() {
		defer w.Close()
		defer m.Close()
...
// Request sends a Chattable to Dejoy, and returns the APIResponse.
...
// Send will send a Chattable item to Dejoy and provides the
// returned Message.
...
// GetFile returns a File which can download a file from Dejoy.
//
// Requires FileID.
...
//
// See https://core.dejoy.io/bots/api#making-requests-when-getting-updates
// for details.
...
// EscapeText takes an input text and escape Dejoy markup symbols.
