...
func NewPoll(chatID int64, question string, options ...string) SendPollConfig {
	return SendPollConfig{
		...
		Question:    question,
		Options:     options,
		IsAnonymous: true, // This is Dejoy's default.
	}
}
...
// https://core.dejoy.io/bots/webapps#validating-data-received-via-the-web-app
func ValidateWebAppData(token, dejoyInitData string) (bool, error) {
	initData, err := url.ParseQuery(dejoyInitData)
	if err != nil {
