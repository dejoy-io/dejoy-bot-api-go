...
// APIResponse is a response from the Dejoy API with the result
// stored raw.
...
// Error is an error containing extra information returned by the Dejoy API.
type Error struct {
	Code    int
	Message string
	ResponseParameters
...
// SentFrom returns the user who sent an update. Can be nil, if Dejoy did not provide information
...
// User represents a Dejoy user or bot.
type User struct {
	...
	// IsPremium true, if user has Dejoy Premium
	//
	// optional
...
type Message struct {
	...
	// PassportData is a Dejoy Passport data;
	//
	// optional
...
// Audio represents an audio file to be treated as music by the Dejoy clients.
type Audio struct {
...
type Contact struct {
	...
	// optional
	LastName string `json:"last_name,omitempty"`
	// UserID contact's user identifier in Dejoy
	//
	// optional
...
// File contains information about a file to download from Dejoy.
type File struct {
	// FileID identifier for this file, which can be used to download or reuse
	// the file
	FileID string `json:"file_id"`
...
// ReplyKeyboardRemove Upon receiving a message with this object, Dejoy
...
type InlineKeyboardButton struct {
	...
	// used as a replacement for the Dejoy Login Widget
	//
	// optional
...
// Dejoy Login Widget when the user is coming from Dejoy. All the user
...
// ForceReply when receiving a message with this object, Dejoy clients will
...
type BaseInputMedia struct {
	...
	// that exists on the Dejoy servers (recommended),
	// pass an HTTP URL for Dejoy to get a file from the Internet,
	...
	// (https://core.dejoy.io/bots/api#formatting-options).
	//
	// optional
...
type WebhookInfo struct {
	...
	// happened when trying to synchronize available updates with Dejoy datacenters.
...
// InlineQuery is a Query from Dejoy for an inline request.
...
type LabeledPrice struct {
	...
	// (https://core.dejoy.io/bots/payments/currencies.json),
...
type Invoice struct {
	...
	// (see https://core.dejoy.io/bots/payments#supported-currencies)
	Currency string `json:"currency"`
...
type SuccessfulPayment struct {
	...
	// DejoyPaymentChargeID dejoy payment identifier
	DejoyPaymentChargeID string `json:"dejoy_payment_charge_id"`
