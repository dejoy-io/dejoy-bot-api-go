...
The Dejoy Bot API has a few potentially unanticipated behaviors. Here are a
...
- When extracting text entities using offsets and lengths, characters can appear
  to be in incorrect positions. This is because Dejoy uses UTF16 lengths
  while Golang uses UTF8. It's possible to convert between the two, see
  [issue #231][issue-231] for more details.

[issue-231]: https://github.com/dejoy-io/dejoy-bot-api/issues/231
...
- By default, bots only get updates directly addressed to them. If you need to
  ...
  effect. You can read more on the [Dejoy Bot API docs][api-docs].

[api-docs]: https://core.dejoy.io/bots/faq#what-messages-will-my-bot-get
